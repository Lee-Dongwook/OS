...
KERNEL_OBJS = $(BUILD_DIR)/kernel_main.o $(BUILD_DIR)/font.o $(BUILD_DIR)/console.o $(BUILD_DIR)/pmm.o $(BUILD_DIR)/vmm.o $(BUILD_DIR)/idt.o $(BUILD_DIR)/mach_ipc.o $(BUILD_DIR)/scheduler.o $(BUILD_DIR)/apic.o
